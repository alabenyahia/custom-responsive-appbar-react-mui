    ...
    <Box sx={{ display: "flex" }}>
      ...
      <Box component="main" sx={{ p: 3 }}>
        ...
        <Typography>
          ...
          veniam nostrum veritatis deserunt doloribus, nam placeat perferendis
          earum blanditiis officiis voluptatum tempore quae similique, quas ea
          sequi rem cumque!
        </Typography>
      </Box>
    </Box>
